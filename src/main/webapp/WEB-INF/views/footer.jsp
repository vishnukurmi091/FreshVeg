...
<!-- Footer Start -->
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">freshfarm@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">Your Site Name</a>. All Rights Reserved. Designed by <a class="text-secondary fw-bold" href="https://htmlcodex.com">Vishnu Kurmi!</a></p>
        </div>
    </div>
    <!-- Footer End -->
