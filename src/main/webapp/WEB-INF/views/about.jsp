            ...
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="d-flex h-100 border border-5 border-primary border-bottom-0 pt-4">
                        <img class="img-fluid mt-auto mx-auto" src="img/about.png" alt="About Us Image">
                    </div>
                </div>
                <div class="col-lg-6 pb-5">
                    <div class="mb-3 pb-2">
                        <h6 class="text-primary text-uppercase">About Us</h6>
                        <h1 class="display-5">We Grow and Provide Fresh Organic Produce</h1>
                    </div>
                    <p class="mb-4">At our farm, we are passionate about providing healthy, organic food directly from our fields to your table. We believe in sustainable farming practices that nurture the land and give you the highest quality produce.</p>
                    <div class="row gx-5 gy-4">
                        <div class="col-sm-6">
                            <i class="fa fa-seedling display-1 text-secondary"></i>
                            <h4>100% Organic</h4>
                            <p class="mb-0">Our crops are grown without the use of harmful chemicals, ensuring that what you eat is safe and healthy.</p>
                        </div>
                        <div class="col-sm-6">
                            <i class="fa fa-award display-1 text-secondary"></i>
                            <h4>Award Winning</h4>
                            <p class="mb-0">We have received numerous accolades for our commitment to sustainable farming and top-quality produce.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-5 gy-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex">
                        ...
                        <div class="ps-4">
                            <h5 class="text-white">Dedicated Farmers</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex">
                        ...
                        <div class="ps-4">
                            <h5 class="text-white">Successful Harvests</h5>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                ...
                <h1 class="display-5">Meet the Dedicated Farmers Behind Our Success</h1>
            </div>
            <div class="row g-5">
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/team-1.jpg" alt="Team Member 1">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">John Doe</h4>
                                    <span class="text-white">Lead Farmer</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/team-2.jpg" alt="Team Member 2">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Jane Smith</h4>
                                    <span class="text-white">Farm Specialist</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/team-3.jpg" alt="Team Member 3">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Alex Lee</h4>
                                    <span class="text-white">Agronomy Expert</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
